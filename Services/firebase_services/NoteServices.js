...
class FirebaseService {
    _storeNoteService = async (notekey, title, note, labels, reminder) => {
    ...
    _updateNoteService = async (key, title, note, labels, reminder) => {
        const userid = JSON.parse(await AsyncStorage.getItem('userId'));
        return new Promise((resolve, reject) => {
            const notes = {
                title: title,
    ...
    storeNoteIdIntoLabels = async (labelId, noteid, labelName) => {
        const userid = JSON.parse(await AsyncStorage.getItem('userId'))
        return new Promise((resolve, reject) => {
            Firebase.database().ref('Labels/' + userid + '/' + labelId).set({
                noteid: noteid,
    ...
    storeArchiveToDatabase = async (notekey, title, note, labels, reminder) => {
        const userid = JSON.parse(await AsyncStorage.getItem('userId'))
        return new Promise((resolve, reject) => {
            const notes = {
                title: title,
